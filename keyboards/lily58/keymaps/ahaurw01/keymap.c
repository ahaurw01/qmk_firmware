 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LOWER | LAlt | LGUI | /Space  /       \Space \  |RAISE |   =  |   \  |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT, \
                             LOWER, KC_LALT, KC_LGUI, KC_SPC,  KC_SPC, RAISE,  KC_EQL,  KC_BSLS \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, KC_UNDS, KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, \
 ...
 */
  ...
  RESET,  EEP_RST, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD,\
                             _______, _______, _______, _______, _______,  _______, _______, _______ \
  )
};
